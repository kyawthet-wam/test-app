...
class _$CourseTearOff {
  ...
  _Course call({String id = '', String name = '', String icon = '0xe146'}) {
    return _Course(
      id: id,
      name: name,
      icon: icon,
...
class _$_Course implements _Course {
  const _$_Course({this.id = '', this.name = '', this.icon = '0xe146'});
...
abstract class _Course implements Course {
  const factory _Course({String id, String name, String icon}) = _$_Course;
